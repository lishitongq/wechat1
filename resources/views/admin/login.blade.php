...
<body>
	...
	<div class="logDiv">
		...
		<div class="logGet">
			...
			<!-- 输入框 -->
				<div class="lgD">
					<img class="img1" src="/img/logName.png" /><input type="text" name="user_name" placeholder="输入用户名" />
				</div>
				<div class="lgD">
					<img class="img1" src="/img/logPwd.png" /><input type="password" name="user_pwd" placeholder="输入用户密码" />
				</div>
				<!-- <div class="lgD logD2">
